...
C                                                                      C
      ...
      DIMENSION XQ(9)
C
      CALL YTCP_DME30(P, T, Y, C)
      CALL RATT_DME30(T, RF, RB, RKLOW)
      CALL RATX_DME30(T, C, RF, RB, RKLOW)
      CALL QSSA_DME30(RF, RB, XQ)
      CALL RDOT_DME30(RF, RB, WDOT)
C
      END
C                                                                      C
C----------------------------------------------------------------------C
C                                                                      C
      SUBROUTINE YTCP_DME30 (P, T, Y, C)
      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
      DIMENSION Y(*), C(*)
      DATA SMALL/1D-50/
C
...
C----------------------------------------------------------------------C
C                                                                      C
      SUBROUTINE RATT_DME30 (T, RF, RB, RKLOW)
      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
...
C----------------------------------------------------------------------C
C                                                                      C
      SUBROUTINE RATX_DME30 (T, C, RF, RB, RKLOW)
      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
...
C----------------------------------------------------------------------C
C                                                                      C
      SUBROUTINE QSSA_DME30(RF, RB, XQ)
      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
      DIMENSION RF(*), RB(*), XQ(*)
      PARAMETER (SMALL = 1D-200)
C
...
C----------------------------------------------------------------------C
C                                                                      C
      SUBROUTINE RDOT_DME30(RF, RB, WDOT)
      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
