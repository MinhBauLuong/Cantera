...
C----------------------------------------------------------------------C
C                                                                      C
      SUBROUTINE DME30  (P, T, Y, WDOT)
      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
      DIMENSION Y(*),WDOT(*)
      DIMENSION RF(175),RB(175),RKLOW(11),C(30)
      DIMENSION XQ(9)
     
      PARAMETER (RU=8.314510D7, PATM=1.01325D6, SMALL = 1.D-50)
      DIMENSION TN(5), SMH(38), EG(38)
C
C      CALL YTCP(P, T, Y, C)
...
C----------------------------------------------------------------------C
C                                                                      C
C      SUBROUTINE RATT (T, RF, RB, RKLOW)
C      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
C      PARAMETER (RU=8.31451D7, SMALL=1.D-200, PATM=1.01325D6)
C      DIMENSION RF(*), RB(*), RKLOW(*)
C      DIMENSION SMH(38), EG(38) #Need to be defined
C
      ALOGT = LOG(T)
      TI = 1D0/T
      TI2 = TI*TI
...
C----------------------------------------------------------------------C
C                                                                      C
C      SUBROUTINE RDSMH  (T, SMH)
C      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
C      DIMENSION SMH(*), TN(5) #Need to be defined
C
...
C----------------------------------------------------------------------C
C                                                                      C
C      SUBROUTINE RATX (T, C, RF, RB, RKLOW)
C      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
C      PARAMETER (SMALL = 1D-200)
C      DIMENSION C(*), RF(*), RB(*), RKLOW(*)
C
      ALOGT = LOG(T)
      CTOT = 0.0
      DO K = 1, 30
...
C----------------------------------------------------------------------C
C                                                                      C
C      SUBROUTINE QSSA(RF, RB, XQ)
C      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
C      DIMENSION RF(*), RB(*), XQ(*)
C      PARAMETER (SMALL = 1D-200)
C
      RF(33) = 0.D0
      RF(35) = 0.D0
...
C----------------------------------------------------------------------C
C                                                                      C
C      SUBROUTINE RDOT(RF, RB, WDOT)
C      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
C      DIMENSION RF(*), RB(*), WDOT(*)
C
      DO K = 1, 30
         WDOT(K) = 0D0
      ENDDO
