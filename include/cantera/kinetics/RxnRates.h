...
/* Added by Alireza Najafiyazdi */
    double getPreExponential(){ return this->m_A;}
    double getTempExponent(){return this->m_b;}
    double getActivationEnergy(){return this->m_E;}

    void setPreExponential(double A){ this->m_A=A;}
    void setTempExponent(double b){this->m_b=b;}
    void setActivationEnergy(double E){ this->m_E=E;}
    void updateCoeffs(double A, double b, double E)
    { 
         this->m_A=A;
         this->m_b=b;
         this->m_E=E; 
