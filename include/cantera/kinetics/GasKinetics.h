...
/* added by Alireza Najafiyazdi*/
    virtual void getArrheniusCoeffs(int ir, double* C) {
    /* returns the Arrhenius Coefficients of reaction "ir"*/
       this->m_rates.getRateCoeff(ir,C);
    }

    virtual void setArrheniusCoeffs(int ir, double* C) {
    /* returns the Arrhenius Coefficients of reaction "ir"*/
       this->m_rates.setRateCoeff(ir,C);
    }
...
protected:
    ...
    mutable std::vector<std::map<size_t, doublereal> >   m_rorxn;
