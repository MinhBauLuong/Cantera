...
//void InterfaceKinetics::getAVBPFwdRatesOfProgress(doublereal* fwdAVBPROP)
//{
//    updateROP();
//    std::copy(m_ropf_avbp.begin(), m_ropf_avbp.end(), fwdAVBPROP);
//}
...
void InterfaceKinetics::installReagents(const ReactionData& r)
{
    ...
    for (n = 0; n < nr; n++) {
        ...
        m_rorxn[r.reactants[n]][rnum] = r.rorder[n];
        for (m = 0; m < ns; m++) {
